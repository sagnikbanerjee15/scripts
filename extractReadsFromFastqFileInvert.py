...
def extractReadsInvert(fastqfilename,readfilenames):
    """
    """
    all_reads=[]
...
def main():
    if len(sys.argv)<1:
        print("Usage: python extractReadsFromFastqFileInvert.py <fastqfilename> <readfilename1> <readfilename2> ... Output will be on stdout")
    fastqfilename=sys.argv[1]
    readfilenames=sys.argv[2:]
    extractReadsInvert(fastqfilename,readfilenames)
